...
export const getSingleLightWoker = createAsyncThunk('light-worker/:id', async (data, thunkAPI) => {
  try {
...
export const addLightWorker = createAsyncThunk('add-light-worker', async (userData, thunkAPI) => {
  try {
...
export const updateLightWorker = createAsyncThunk(
  'update-light-worker',
