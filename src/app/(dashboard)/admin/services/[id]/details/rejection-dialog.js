...
import { manageServiceStatus } from "@/store/services/services.thunk";
...
const RejectionDialog = ({ open, handleDialogState, id }) => {
  ...
  return (
    ...
    >
      <UIInputField label="Reason" name="reason" multiline rows={4} control={control} errorMessage={errors?.reason?.message} />
    </UIDialog>
  );
};
