...
import { Avatar, Chip, Stack, Switch, Tooltip, Typography } from '@mui/material';
import Link from 'next/link';

import { UIIconButton } from '@/shared/components';
import { CalendarIcon } from '@mui/x-date-pickers';

const getServicesColumnHeader = ({ deleteHandler, onStatusChange, user } = {}) => [
  {
    minWidth: 200,
    field: 'title',
    headerName: 'Title',
      ...
      return (
        <Stack direction="row" spacing={1} height="100%" alignItems="center">
          ...
          <Tooltip title={'Activities'}>
            <UIIconButton
              component={Link}
              href={`services/activities/${params.id}`}
              size="small"
              fillable
            >
              <CalendarIcon />
